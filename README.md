...
- **Windows**: 起動後と 6 時間ごとに自動で新しいバージョンを確認します。見つかったら「ヘルプ」→「バージョン」からダウンロード → 再起動で更新できます（次回起動時にも自動で適用されます）。
- **Mac**: 新しいバージョンを検出したら通知しますが、ダウンロードは手動です。「ヘルプ」→「バージョン」→「ダウンロードページを開く」から最新版を入手してください。アプリ内での自動更新には Apple への署名が必要なため、Mac 版はこの形になっています。
